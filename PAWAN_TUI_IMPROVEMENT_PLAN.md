...
1. **Add Session State to TUI App** ✅
   - Location: `~/pawan/crates/pawan-cli/src/tui/mod.rs`
   - Changes:
...
#### Files Modified
```
~/pawan/crates/pawan-cli/src/tui/mod.rs
...
1. **Enhance App State** ✅
   - Location: `~/pawan/crates/pawan-cli/src/main.rs` and `tui/mod.rs`
   - Changes:
...
#### Files Modified
```
~/pawan/crates/pawan-cli/src/main.rs
...
#### Files Modified
```
~/pawan/crates/pawan-cli/src/tui/mod.rs (additive)
...
- TUI frame rate: >30fps on typical server terminal
...
- [ ] Integration tests verify save/load roundtrip
- [ ] Manual testing on server terminal

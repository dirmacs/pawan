...
**Multi-agent identity** — each pawan instance gets an identity derived from its [aegis-net](https://github.com/dirmacs/aegis) peer name (e.g. `pawan@server`). Foundation for swarm coordination.

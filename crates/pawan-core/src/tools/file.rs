...
/// like "~/pawan/grind~/pawan/grind/foo.rs" — it joined the workspace
...
mod tests {
    ...
    fn test_normalize_path_double_prefix() {
        let ws = PathBuf::from("~/pawan/grind");
        // Model passes absolute path with workspace root repeated
        let bad = "~/pawan/grind~/pawan/grind/leftist_heap/src/lib.rs";
        let result = normalize_path(&ws, bad);
        assert_eq!(result, PathBuf::from("~/pawan/grind/leftist_heap/src/lib.rs"));
    }

    #[test]
    fn test_normalize_path_normal_absolute() {
        let ws = PathBuf::from("~/pawan/grind");
        let normal = "~/pawan/grind/trie/src/lib.rs";
        let result = normalize_path(&ws, normal);
        assert_eq!(result, PathBuf::from("~/pawan/grind/trie/src/lib.rs"));
    }

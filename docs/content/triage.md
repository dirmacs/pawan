...
- **988+ tests** passing with 74.58% line / 74.80% region / 77.34% function coverage (cargo-llvm-cov baseline); 45 new tests added in v0.5.6 (29 compaction, 16 eruka, 53 TUI types)

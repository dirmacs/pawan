...
- **1779 tests** passing across 18 suites; major test additions in v0.5.7–v0.5.9 (SubagentCore, ModelCatalog, IrcHub, CommitQueuePanel, Coordinator, GoalLoopRuntime, LspTool, InjectionDetector, TUI model picker)
